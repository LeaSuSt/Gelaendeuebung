...
delta_libelle = 0.5*1.45*10**(-7)        #rad | Fehler auf die Genauigkeit der Horizontierung mit den Libellen; 1 Teilstrich entspricht 1.45*10**(-7) rad
...
#output
print("delta_g = ", delta_g, " ist der theoretische statistische Fehler auf g.")
print("delta_g_std = ", delta_g_std, " ist der statistische Fehler bei der Bestimmung der driftkorrigierten Werte von g aus den Mittelwerten der Tabelle.")
