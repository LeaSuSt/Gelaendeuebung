...
TH        = 47000;   % Totalintansitaet des Hintergrundfeldes (in nT)
beta      = 20;       % Streichwinkel des Gangs (abgetragen im Uhrzeigersinn, in °, 0°=N-S-Richtung)
xi        = 90;      % Neigung des Gangs (abgetragen im Gegenuhrzeigersinn, in °, 90°=vertikal)
kappa     = 0.003;  % magnetische Suszeptibilitaet
d         = 4.0;     % Tiefe Gangoberkante (in m)
D         = 350;     % Tiefe Gangunterkante (in m)
b         = 4.0;     % Gangbreite (in m)
XPOS      = 40;      % Verschiebung des Ursprungs des Koordinatensystems der Modellierung
DATASHIFT = 47900;   % Offset der Messung (Messwert an der Basis)

% =========================================================================
% Konfiguration der Abbildung

xrange        = [-40 30];      % x-Achsen-Begrenzung
datarange     = [-200 600];   % y-Achsen-Begrenzung
infoxy        = [15 500];     % Koordinaten (x,y) fuer Infobox mit Gangparametern
