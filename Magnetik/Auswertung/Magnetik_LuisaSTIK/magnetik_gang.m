...
%% ========================================================================
%
% 2018/05/20  V 1.1  update by Andreas Brotzer 
%
%
%% ========================================================================
...
% - Dann wird der Neigungswinkel entgegen dem Uhrzeigersinn bezÃ¼glich der
...
% 
%  gesetzte Variablen:
%   beta_rad: Streichwinkel des Gangs relativ zur Feldrichtung (in Â°)
%   xi_rad: Neigung des Gangs zur Horizontalen (in Â°)
...
%   teta1: Winkel r1 zu Oberflaeche (in Â°)
%   teta2: Winkel r2 zu Oberflaeche (in Â°)
%   teta3: Winkel r3 zu Oberflaeche (in Â°)
%   teta4: Winkel r4 zu Oberflaeche (in Â°)
% 
%  Laufvariable:
...
% Input Textdatei mit 2 Spalten: 
% 1 = Koordinate, 2 = Messwert

data_file = 'm21_m1_mean.txt';
...
TH        = 48100;   % Totalintansitaet des Hintergrundfeldes (in nT)
beta      = 0;      % Streichwinkel des Gangs (abgetragen im Uhrzeigersinn, in °, 0°=N-S-Richtung)
xi        = 90;      % Neigung des Gangs (abgetragen im Gegenuhrzeigersinn, in °, 90°=vertikal)
kappa     = 0.01;   % magnetische Suszeptibilitaet
d         = 3.0;     % Tiefe Gangoberkante (in m)
D         = 350;     % Tiefe Gangunterkante (in m)
b         = 7.0;     % Gangbreite (in m)
XPOS      = 14;      % Verschiebung des Ursprungs des Koordinatensystems der Modellierung
DATASHIFT = 48100;   % Offset der Messung (Messwert an der Basis)

% =========================================================================
% Konfiguration der Abbildung

xrange        = [-10 40];      % x-Achsen-Begrenzung
datarange     = [0 1800];   % y-Achsen-Begrenzung
infoxy        = [30 1500];     % Koordinaten (x,y) fuer Infobox mit Gangparametern
Legende_Daten = 'Messwerte 2003, Messgebiet A59/1';   % Legendeneintrag der Messwerte

dx            = 0.5;             % Spacing des x-Vektors zur Generierung der Modelldaten
...
plot(x+XPOS, TA, 'color',[1 1 1]*0.3, 'linewidth',1);
hold on;
box on;
grid on;
...
title('\bf Anomalie der Totalintensit\"at (Annahme: Gang)', 'fontsize',14, 'visible','on');
