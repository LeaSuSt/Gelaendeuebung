...
Betreuer: Val\'{e}rie Krampe und Tilman Steinweg}
...
%     \pseudochapter[3]{Messprotokoll 2}  % usage: \pseudochapter[number of pages 
    ...
    \input{./chap/theorie.tex} %\cleardoublepage
    
    \chapter{Versuchsdurchführung}
    \input{./chap/beschreibung.tex}
    
    \chapter{Auswertung}
    \input{./chap/auswertung.tex}
    
    \chapter{Fehlerbetrachtung}
    \input{./chap/fehlerbetrachtung.tex}
    
    \chapter{Zusammenfassung}
    \input{./chap/zusammenfassung.tex}
